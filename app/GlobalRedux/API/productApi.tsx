...
export const productApi = createApi({
  ...
  endpoints: (builder) => ({
    ...
    getAllRecordForSpecificSchool: builder.mutation({
      query: () => {
        return {
          url: `product/get-all-for-school`,
          method: "POST",
          formData: true,
          headers: {
            "x-school-id": getDataByValue("schoolId"),
...
export const { usePostAddRecordMutation, useGetAllRecordForSpecificSchoolMutation, useDeleteRecordMutation, usePatchUpdateRecordMutation } = productApi;
